...
public class PasswordManagerActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getLastCustomNonConfigurationInstance() != null) {
            changePasswdTask = (ChangePasswdTask) getLastCustomNonConfigurationInstance();
    ...
    static class ChangePasswdTask extends AsyncTask<String, Void, Integer> {
        ...
        private PasswordManagerActivity activity;
        private String currentPasswd;
        private String newPasswd;

        ChangePasswdTask(PasswordManagerActivity activity) {
            this.activity = activity;
        }

        void attach(PasswordManagerActivity activity) {
            this.activity = activity;
        }
                    ...
                    .setPositiveButton(android.R.string.yes,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                        int whichButton) {
                                    ((PasswordManagerActivity) getActivity())
